...
const Quiz = {
  quizData: [
    {
      question: "Which formwork material is best suited for regions with extreme temperature fluctuations?",
      a: "Plastic",
      b: "Timber",
      c: "Steel",
      d: "Plywood ",
    ...
    {
      question: "Which method is commonly used to improve the durability of reusable formwork components?",
      a: "Using thicker materials",
      b: "Applying form release agents",
      c: "Using more water in the concrete mix",
      d: "Increasing the curing time ",
      correct: "b",
    },
    {
      question: "What is the typical cause of honeycombing in concrete?",
      a: "Slow concrete placement",
      b: "Insufficient vibration of concrete",
      c: "Overuse of formwork materials",
      d: "Use of high-quality formwork ",
      correct: "b",
    },
  ],
...
const Scenes = {
  ...
  steps: [
    ...
    (step1 = function () {
      ...
      Scenes.items.chalk_with_hand.set(140, 138, 80, 70).zIndex(6).cursor();
        ...
        switch (drillMachineCount) {
          ...
          case 1:
            Dom.animePush(anime
              ...
              .add({
                keyframes: [{ left: 317 }, { left: "-=12", duration: 1500 }, { left: "+=12", duration: 1500 }],
                complete() {
                  Scenes.items.beam_3d_with_one_hole.hide();
                  Scenes.items.beam_3d_with_holes2.set(250, 93, 350);
                },
    ...
    (step4 = function () {
      ...
      setIsProcessRunning(true);
      Scenes.items.contentAdderBox.setContent("");
      Scenes.setStepHeading("Step 4", "Join the steel waler with timber beam using flenge claw assembly.");
      ...
      // ! after rotation
      Scenes.items.beam_3d_with_holes3
        .set(178 + 150, 78, 345)
        .zIndex(2)
        .hide();
      Scenes.items.beam_3d_with_holes4
        .set(250 + 150, 93, 350)
        .zIndex(2)
        .hide();
      ...
      const beforeAfterRotationAnime = () => {
        Dom.animePush(anime
          ...
          .add({
            targets: [
              Scenes.items.beam_3d_with_holes4.item,
              Scenes.items.beam_3d_with_holes3.item,
              Scenes.items.sheathing_full2.item,
            ],
            left: "-=200",
            complete() {
              Scenes.showArrowForMenuItem();
    ...
    (step5 = function () {
      setIsProcessRunning(true);
      Dom.hideAll();
      Scenes.setStepHeading("Step 5", "Lift the one side of wall and attach CT prop.");
      ...
      Scenes.items.steel_waler_tilt1
        .set(300 - 50, 125, 65)
        .zIndex(5)
        .rotate(-4);
      Scenes.items.steel_waler_tilt2
        .set(155 - 50, 224, 65)
        .zIndex(5)
        .rotate(-4);
      Scenes.items.flange_claw1
        .set(378 - 50, 143, 50, 60)
        .rotate(127)
        .zIndex(4);
      Scenes.items.flange_claw2
        .set(303 - 50, 122, 50, 60)
        .rotate(127)
        .zIndex(4);
      Scenes.items.flange_claw3
        .set(240 - 50, 244, 50, 60)
        .rotate(130)
        .zIndex(4);
      Scenes.items.flange_claw4
        .set(156 - 50, 220, 50, 60)
        .rotate(130)
        .zIndex(4);
    ...
    (step6 = function () {
      ...
      Scenes.setStepHeading("Step 6", "Bring timber beam and drill holes on it to make other side.");
        ...
        switch (drillMachineCount) {
          ...
          case 1:
            Dom.animePush(anime
              ...
              .add({
                keyframes: [{ left: 236 }, { left: "-=17", duration: 1500 }, { left: "+=17", duration: 1500 }],
                complete() {
          ...
          case 2:
            Dom.animePush(anime
              ...
              .add({
                keyframes: [{ left: 407 }, { left: "-=17", duration: 1500 }, { left: "+=17", duration: 1500 }],
                complete() {
    ...
    (step7 = function () {
      ...
      Scenes.setStepHeading("Step 7", "Place playwood sheathing on a timberbeam with the help of nailing.");
    ...
    (step8 = function () {
      ...
      setIsProcessRunning(true);
      Scenes.items.contentAdderBox.setContent("");
      Scenes.setStepHeading("Step 8", "Join the steel waler with timber beam using flenge claw assembly.");
    ...
    (step9 = function () {
      setIsProcessRunning(true);
      Dom.hideAll();
      Scenes.setStepHeading("Step 9", "Lift the one side of wall and attach CT prop.");
      // todo remove all previous
      Scenes.items.contentAdderBox.setContent("");
      ...
      Scenes.items.foot_adapter1
        .set(480 - 15, 310, 75)
        .zIndex(12)
        .hide();
      Scenes.items.foot_adapter2
        .set(540 - 15, 310, 75)
        .zIndex(12)
        .hide();
    ...
    (step10 = function () {
      setIsProcessRunning(true);
      Dom.hideAll();
      Scenes.setStepHeading("Step 10", "Repeat step 2 to step 9 to build remaining three sides of the wall.");
      // todo remove all previous
      Scenes.items.contentAdderBox.setContent("");
